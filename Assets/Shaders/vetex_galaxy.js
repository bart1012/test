const galaxyVertex = /*glsl*/`
            ...
            */
            void main(){
                ...
                float particle_size = cnoise(vec4(pos*8., 1.0));
                vec3 world_pos = rotation3dY(time*0.3*(0.1+0.5*particle_size))*pos;          // float particle_size = cnoise(pos)*0.5+0.5;
