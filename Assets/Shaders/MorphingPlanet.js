...
//control amplitude, sharpness, water worlds - solid terrain - 
    const planetParams = {
        ...
        amplitude: { value: 1.0866},
        // amplitude: { value: 0.0 },
        // sharpness: { value: 2.6 },
        sharpness: { value: 1.185 },
        // offset: { value: -0.016 },
        offset: { value: 2 },
        ...
        diffuseIntensity: { value: 1.25 },
        specularIntensity: { value: 2 },
        shininess: { value: 10 },
        lightDirection: { value: new Vector3(-2, 5, 1) },
        lightColor: { value: new Color(0xffffff) },
        //light
        bumpStrength: { value: 1.0 },
        bumpOffset: { value: 0.001 },
        color1: { value: new Color(0.014, 0.117, 0.279) },
        color2: { value: new Color(0.080, 0.527, 0.351) },
        color3: { value: new Color(0.620, 0.516, 0.372) },
        color4: { value: new Color(0.149, 0.254, 0.084) },
        color5: { value: new Color(0.150, 0.150, 0.150) },
